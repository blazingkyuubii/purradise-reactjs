  ...
  return (
    <div>
      ...
      <div className="p-12 grid grid-cols-2 mx-auto">
        {/* image */}
        <div className="max-w-xl mx-5 border border-solid border-stone-500">
          <img className='' src={product.prodImg} alt={product.prodName} />
        </div>

        {/* product info */}
        <div className="p-10 border border-solid border-stone-500 rounded shadow-md">
          ...
          <div className="relative mb-5">
            <button className="bg-blue-500 text-white px-4 py-2 rounded-l focus:outline-none focus:shadow-outline-blue active:bg-blue-700">
              -
            </button>
            <input
              type="text"
              ...
              value="1"
            />
            <button className="bg-blue-500 text-white px-4 py-2 rounded-r focus:outline-none focus:shadow-outline-blue active:bg-blue-700">
              +
            </button>
          </div>
